...
% dailyCI.m
% 
% Generates and saves daily time series of CI and CInight:CIday.
% Uses results from LTSA (BlueCIbasis.mat).
%
% Will Oestreich
...
t=cell2table(a);
writetable(t,'outputs/ci_daily_seq_dates.csv')
csvwrite('outputs/ci_daily_seq.csv',DCI.blue)